...
<body>
    <div class="admin-container">
        <div class="admin-header">
            ...
            <p><strong>⚠️ ACESSO RESTRITO - NÃO COMPARTILHE ESTA URL</strong></p>
        </div>
    ...
    <script>
        ...
        async function cancelReservation(reservationId) {
            ...
            try {
                const response = await fetch(`/admin/cancel-reservation/${reservationId}`, {
                    method: 'DELETE'
                });
...
@admin_bp.route('/admin/cancel-reservation/<int:reservation_id>', methods=['DELETE'])
